  ...
  final bindings = <Type, obx_int.EntityDefinition>{
    NoRushReminderEntity: obx_int.EntityDefinition<NoRushReminderEntity>(
      ...
      objectFromFB: (obx.Store store, ByteData fbData) {
        ...
        final autoSnoozeIntervalParam = const fb.Int64Reader().vTableGet(
          buffer,
          rootOffset,
          12,
          0,
    ...
    ReminderEntity: obx_int.EntityDefinition<ReminderEntity>(
      ...
      objectToFB: (ReminderEntity object, fb.Builder fbb) {
        ...
        final recurringIntervalOffset = fbb.writeString(
      ...
      objectFromFB: (obx.Store store, ByteData fbData) {
        ...
        final preParsedTitleParam = const fb.StringReader(
          asciiOptimization: true,
        ...
        final recurringIntervalParam = const fb.StringReader(
          asciiOptimization: true,
        ).vTableGet(buffer, rootOffset, 14, '');
        final baseDateTimeParam = DateTime.fromMillisecondsSinceEpoch(
          const fb.Int64Reader().vTableGet(buffer, rootOffset, 16, 0),
        );
        final pausedParam = const fb.BoolReader().vTableGet(
          buffer,
          rootOffset,
          18,
          false,
...
class NoRushReminderEntity_ {
  ...
  static final title = obx.QueryStringProperty<NoRushReminderEntity>(
    _entities[0].properties[1],
  );

  /// See [NoRushReminderEntity.dateTime].
  static final dateTime = obx.QueryDateProperty<NoRushReminderEntity>(
...
class ReminderEntity_ {
  ...
  static final id = obx.QueryIntegerProperty<ReminderEntity>(
    _entities[1].properties[0],
  );

  /// See [ReminderEntity.title].
  static final title = obx.QueryStringProperty<ReminderEntity>(
    _entities[1].properties[1],
  );

  /// See [ReminderEntity.dateTime].
  static final dateTime = obx.QueryDateProperty<ReminderEntity>(
    _entities[1].properties[2],
  );

  /// See [ReminderEntity.preParsedTitle].
  static final preParsedTitle = obx.QueryStringProperty<ReminderEntity>(
    _entities[1].properties[3],
  );

  /// See [ReminderEntity.autoSnoozeInterval].
  static final autoSnoozeInterval = obx.QueryIntegerProperty<ReminderEntity>(
    _entities[1].properties[4],
  );

  /// See [ReminderEntity.recurringInterval].
  static final recurringInterval = obx.QueryStringProperty<ReminderEntity>(
    _entities[1].properties[5],
  );

  /// See [ReminderEntity.baseDateTime].
  static final baseDateTime = obx.QueryDateProperty<ReminderEntity>(
    _entities[1].properties[6],
  );

  /// See [ReminderEntity.paused].
  static final paused = obx.QueryBooleanProperty<ReminderEntity>(
